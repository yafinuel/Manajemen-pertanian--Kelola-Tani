...
<body>
    <div class="wrap container-fluid d-flex flex-column justify-content-center align-items-center">
        ...
        <a href="views/home/home.php"><button type="button" class="btn btn-primary-green border-0" style="--bs-btn-padding-y: .75rem; --bs-btn-padding-x: 1.5rem; --bs-btn-font-size: 1rem;">Masuk</button></a>
    </div>
